...
public class CounterTypeController {
    ...
    private static final Object PAGE_TYPE = "counter_type";
    @Autowired
    @Qualifier("counterTypeService")
    BaseService<CounterTypes> service;
    ...
    public String newEntity(ModelMap model) {
        CounterTypes entity = new CounterTypes();
    ...
    public String saveEntity(CounterTypes entity, BindingResult result,
                             ModelMap model) {
        ...
        model.addAttribute("success", PAGE_TYPE + entity.getSymbol() + " registered successfully");
    ...
    public String editEntity(@PathVariable Long entityId, ModelMap model) {
        CounterTypes entity = service.findEntityById(entityId);
        model.addAttribute("entity", entity);
    ...
    public String updateEntity(CounterTypes entity, BindingResult result,
        ...
        model.addAttribute("success", PAGE_TYPE + entity.getSymbol() + " updated successfully");
        model.addAttribute("pageType", PAGE_TYPE);
        return "success";
    }
